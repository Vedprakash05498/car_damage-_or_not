...
# Assuming `ft_model` is the trained model from the uploaded script
# Replace `ft_model` with the actual model variable if it's named differently
model_filename = 'model.pkl'

# Save the model
joblib.dump(ft_model, model_filename)
